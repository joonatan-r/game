const options = {
    ...
    TRAVEL_REPEAT_START_DELAY: 150, // milliseconds for the delay before holding a key to move starts repeating
    TRAVEL_REPEAT_DELAY: 100, // milliseconds between each move when holding a moving key
