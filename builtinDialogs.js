...
import options, { constants, controlNameMap, optionNameMap } from "./options.js";
            ...
            idx => {
                switch (idx) {
                    ...
                    case 1:
                        ...
                        this.gm.player.visualPos[0] *= constants.CELL_SIZE;
                        this.gm.player.visualPos[1] *= constants.CELL_SIZE;
